...
const PostListItem = ({ slug, metadata }: AllMetadataType) => {
  ...
  return (
    <div className="flex flex-col mb-10 w-full border-2 rounded-lg p-10 gap-2 hover:shadow-lg">
      <Link
        href={{
          pathname: '/post/[slug]',
          query: { slug },
      ...
      >
        <p className="text-xl font-bold cursor-pointer hover:underline">{metadata.title}</p>
      </Link>
